...
[image_obj3, networknames] =load_image_set('bucknerlab');
image_obj3= resample_space(image_obj3,combined_dat,'nearest');
...
layer2colors = C;
image_obj3.image_names=networknames;
riverplot(combined_dat,'layer2',image_obj3,'pos','thin','colors1',layer1colors,'colors2',layer2colors,'reorder')
imagenames3=networknames';
...
saveas(gcf, [basedir 'Results' filesep 'Fig4dright'], 'png')